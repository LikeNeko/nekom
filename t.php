...
function sys_windows()
{
    ...
    $res['win_n'] = $sysinfo[0]['Caption']." ".$sysinfo[0]['CSDVersion']." serial number:{$sysinfo[0]['SerialNumber']} in".date('Y-m-d H:i:s',strtotime(substr($sysinfo[0]['InstallDate'],0,14)))."安装";
    //UPTIME
...
<div id="page">
    <div id="header">
        <h1><a href="prober.php"><?php echo $title;?></a></h1>
    </div>
    <!--服务器相关参数-->
    ...
    <?if("show"==$sysReShow){?>
        <table width="100%" cellpadding="3" cellspacing="0" align="center">
            <tr><th colspan="6">Real-time Data</th></tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="5">
                    ...
                    %
                    <div class="bar"><div id="barswapPercent" class="barli_red" style="width:<?php echo $swapPercent?>%" >&nbsp;</div> </di
                        v>
    ...
    <table width="100%" cellpadding="3" cellspacing="0" align="center">
        <tr>
            <th colspan="4" class="th_1">PHP Modules</th>
        </tr>
        <tr>
