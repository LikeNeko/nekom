...
function scp_comment_post( $incoming_comment ) {
  if(!preg_match('/[一-龥]/u', $incoming_comment['comment_content'])){
    siren_ajax_comment_err('写点汉字吧，站长外语很捉急。You should type some Chinese word.');
  }
        ...
        <div class="contents">
          <div class="comment-arrow">
            <div class="main shadow">
                <div class="profile">
                  <a href="<?php comment_author_url(); ?>"><?php echo get_avatar( $comment, '80', 'mystery'); ?></a>
                </div>
                <div class="commentinfo">
                  <section class="commeta">
                    <div class="left">
                      <h4 class="author"><a href="<?php comment_author_url(); ?>"><?php echo get_avatar( $comment, '80', 'mystery'); ?><?php comment_author(); ?> <span class="isauthor" title="<?php esc_attr_e('Author', 'akina'); ?>"></span></a></h4>
                    </div>
                    <div class="right">
...
function login_ok(){ 
  ...
  wp_get_current_user();
?>
  <p class="ex-login-avatar"><a href="#" class="user-panel"><?php echo get_avatar( $current_user, '100', 'mystery'); ?></a></p>
  <p class="ex-login-username"><strong><?php echo $current_user->display_name; ?></strong> 小主人好 >ω< </p>
...
function the_headPattern(){
  ...
  <div class="pattern-center <?php if(is_single()){echo $center;} ?>">
    <div class="pattern-attachment-img" style="background-image: url(<?php bloginfo('template_url'); ?>/images/t/<?php echo rand(1,10)?>.png)"> </div>
...
function header_user_menu(){
  ...
  if(is_user_logged_in()){
    ...
    <!--添加自定义头像-->
     <a href="#" class="user-panel"><?php echo get_avatar( $current_user, '110', 'mystery'); ?></a>
