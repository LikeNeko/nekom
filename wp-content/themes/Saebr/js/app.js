    ...
    XCS: function(){
        ...
        jQuery(document).on("submit", "#commentform", function() {
            jQuery.ajax({
                ...
                beforeSend: addComment.createButterbar("寄出中...."),
...
$(function() {
    ...
    console.log("%c Neko  %c","background:#24272A; color:#ffffff","","向三位作者致敬。∠( °ω°)／ ");
	console.log("%c Saber %c","background:#24272A; color:#ffffff","","向两位原作者致敬。");
	console.log("%c Akina %c","background:#24272A; color:#ffffff","","http://fui.im"); 
    console.log("%c Louie %c","background:#24272A; color:#ffffff","","http://i94.me");

    var secondary = $("#secondary").clone();
    $("#page").append(secondary);
    secondary.remove();
