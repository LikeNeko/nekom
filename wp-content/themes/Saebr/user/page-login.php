		...
		<?php if(!is_user_logged_in()){ ?>
			<div class="ex-login">
				...
				<form action="<?php echo home_url(); ?>/wp-login.php" method="post">  
					<p><input type="text" name="log" id="log" value="<?php echo $_POST['log']; ?>" size="25" placeholder="你的账号/邮箱" required /></p>
				...
				<div class="ex-new-account"><a href="<?php echo akina_option('exregister_url') ? akina_option('exregister_url') : bloginfo('url'); ?>" target="_top">还没有账号？立即注册！</a></div>
			</div>
