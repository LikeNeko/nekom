...
function optionsframework_options() {
   ...
   $options[] = array(
        ...
        'name' => __("插件推荐", ''),
        'desc' => __('这里我推荐使用路易的"Poi Player"插件 下载地址:http://pan.baidu.com/s/1o8a6qwy', ''),
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'name' => __('个人头像[推荐]', 'options_framework_theme'),
		'desc' => __('最佳高度尺寸130px。', 'options_framework_theme'),
		'id' => 'focus_logo',
		'type' => 'upload');

	 $options[] = array(
		'name' => __('背景图[推荐]', 'options_framework_theme'),
		'desc' => __('最佳尺寸1920*1080', 'options_framework_theme'),
		'id' => 'focus_img_1',
		'type' => 'upload');

	$options[] = array(
		'name' => __('背景图 - 2[推荐]', 'options_framework_theme'),
		'desc' => __('可选，最佳尺寸1920*1080，将被随机显示', 'options_framework_theme'),
		'id' => 'focus_img_2',
		'type' => 'upload');

	$options[] = array(
		'name' => __('背景图 - 3[推荐]', 'options_framework_theme'),
		'desc' => __('可选，最佳尺寸1920*1080，将被随机显示', 'options_framework_theme'),
		'id' => 'focus_img_3',
		'type' => 'upload');

	$options[] = array(
		'name' => __('背景图 - 4[推荐]', 'options_framework_theme'),
		'desc' => __('可选，最佳尺寸1920*1080，将被随机显示', 'options_framework_theme'),
		'id' => 'focus_img_4',
		'type' => 'upload');

	$options[] = array(
		'name' => __('背景图 - 5[推荐]', 'options_framework_theme'),
		'desc' => __('可选，最佳尺寸1920*1080，将被随机显示', 'options_framework_theme'),
		'id' => 'focus_img_5',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('开启PJAX局部刷新[推荐]', 'options_framework_theme'),
	...
	$options[] = array(
		'name' => __('指定登录地址[推荐]', 'options_framework_theme'),
	...
	$options[] = array(
		'name' => __('指定注册地址[推荐]', 'options_framework_theme'),
	...
	$options[] = array(
		'name' => __('登录后自动跳转[推荐]', 'options_framework_theme'),
	...
	$options[] = array(
		'name' => __('注册验证[防注册机]', 'options_framework_theme'),
